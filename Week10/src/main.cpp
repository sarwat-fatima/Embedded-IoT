...
#define BLYNK_TEMPLATE_ID "TMPL6Hy1KquOB"
#define BLYNK_TEMPLATE_NAME "dhtharu"
#define BLYNK_AUTH_TOKEN "OlI_xJFbBZI0LWaoNOMtSk4jacgxp9SL"
...
BlynkTimer timer; // software timer
